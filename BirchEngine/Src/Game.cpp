...
void Game::init(const char* title, int width, int height, bool fullscreen) //
{
	...
	// SpriteComponent is responsible for animation and actually drawing the image to  render (its draw function is called via the game.render() -> manager.draw() -> entity.draw() -> SpriteComponent.draw()).
